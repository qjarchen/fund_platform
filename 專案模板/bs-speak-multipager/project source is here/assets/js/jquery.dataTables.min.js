...
(function(h) {
    ...
    function Ya(a, b, c) {
        h(a).on("click.DT", b, function(b) {
            a.blur();
            c(b)
        }).on("keypress.DT", b, function(a) { 13 === a.which && (a.preventDefault(), c(a)) }).on("selectstart.DT", function() {
            return !1
        })
    }
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "First", sLast: "Last", sNext: "下一個", sPrevious: "前一個" },
            sEmptyTable: "No data available in table",
            sInfo: "展示第 _START_ 到 _END_ 個，共 _TOTAL_ 個",
            sInfoEmpty: "Showing 0 to 0 of 0 entries",
            sInfoFiltered: "(filtered from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "展示前 _MENU_ 個",
